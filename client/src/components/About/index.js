        ...
        <Jumbotron className="grayBox1" >
                ...
                <Row>
                        ...
                        <Col>
                            ...
                            <div  className="tooltip1">
                            <h4>Chase Mathews</h4>
                            <span className="tooltiptext"><h3></h3><p>a little blurb about Chase.</p></span>
                            </div>
                        </Col>
                    </Row>
                    </Card.Body>
